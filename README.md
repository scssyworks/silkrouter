...
<b>Note:</b> Please note that this is still an IIFE build, and you would would manually need to include script tag to make it work. We are working on version 2.0 which is a UMD build which will be released on November 30th. Stay tuned!
